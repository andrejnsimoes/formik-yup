              ...
              <Box marginBottom={2}>
                <FormGroup>
                  <Field
                    ...
                    error={touched.initialInvestment && errors.initialInvestment}
              ...
              <Box marginBottom={2}>
                <FormGroup>
                  <Field
                    ...
                    error={touched.commentAboutInvestmentRisk && errors.commentAboutInvestmentRisk}
                    helperText={touched.commentAboutInvestmentRisk && errors.commentAboutInvestmentRisk}
                  />
                </FormGroup>
              </Box>
